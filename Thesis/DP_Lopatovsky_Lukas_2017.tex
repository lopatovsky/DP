...
In this section we are comparing the time performance of two CT-HMM algorithm variants, as described in implementation part \ref{sec:alg}. We have called them float and integer-interval algorithms.
In two subsection we will manipulate either with hidden states number or maximal time interval value and watch, if the measured values correspond to the theoretical expectations \ref{sec:complex}.
