...
The expectation maximization framework for the continuous-time Markov process and Bayesian networks in general was introduce in Article \cite{No12}. It was later extended to CT-HMM with the first proposed efficient algorithm in Article \cite{Li15}. The the article propose various methods for counting of matrix exponentiation.  Eigendecomposition used in article \cite{Wa14}. ...TODO     

-vyuzitia odpisane od clankov + glaukoma + diplomovka London. 

-odkaz na prace co robili cthmm . odkaz na EM algoritmus pre chain. 
...
Soft method and fast option are set to true by default, because they are given best expected results and time efficiency \ref{sec:exper}.
