...
The other method of Uniformization is based on truncating of infinite sum as described in [yu-ying 9]. 
...
Let's have probabilities $ \mathrm{p}_1, \mathrm{p}_2, \cdots ,\mathrm{p}_n $. Now we want to make the sum of them. It is fairly simple, when they are simple float numbers: $\sum_{i=0}^n \mathrm{p}_i$. But it can get trickier, if they are stored in the form of log-probability.  
