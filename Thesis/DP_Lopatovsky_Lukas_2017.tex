...
\section{Future Work}
%rozsirenia - ina reprezentacia matic na sparse , continuous observations, vztah s rekurent neural networks.https://en.wikipedia.org/wiki/Recurrent_neural_network - Continuous time RNN.
