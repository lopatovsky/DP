...
This experiment compare the soft and hard method of EM algorithm described in Section \ref{sec:shm}. The methods differ in their maximization function. The soft method maximize the probability of the dataset being generated by the model, whereas the hard method maximize the probability of most likely state sequence generating the dataset. We have examined the results of these functions for both models.   

\subsubsection*{ Description }

There is any unified result of comparing the methods. Different models generating dataset often produce very different results. However, it still reveals enough about methods for making some conclusions. In the observation part we show ...      
