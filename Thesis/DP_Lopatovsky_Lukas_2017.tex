...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{img/passport.jpg}
...
The later part of the chapter, will contain the experiments, that are in some way connected to the implementation details or its chosen methods.       
...
The thesis are describing two models, discrete-time and continuous-time hidden Markov model. In this test we will compare, how fast can they learn the data (converge to the local optima) and if there is some significant difference among the optima values. 
