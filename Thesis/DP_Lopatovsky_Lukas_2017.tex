...
In general we do not know states of the system during all the time \cite{Li15}. It is only known at some unevenly distributed times of observations $\matr{T} = ( t_0, t_1, \dots, t_{\nu} )$ as $\matr{X}= (x_0, x_1, \dots, x_{\nu} )$. 
...
The emission of the observable variables can occur at any time independently on the state transition times. For example it could be times when the patient undergoes medical examination. The times can generally have highly irregular and unbalanced distribution.
