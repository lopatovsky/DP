...
\begin{algorithm}
\caption{The Expm Based Algorithm for Counting End-States Conditioned Probabilities (Float-Variant)}\label{euclid}
\begin{algorithmic}[1]
\Procedure{Float-Variant}{}
...
\begin{algorithm}
\caption{The Expm Based Algorithm for Counting End-States Conditioned Probabilities (Integer-Variant)}\label{euclid}
\begin{algorithmic}[1]
\Procedure{Integer-Variant}{}
 \ForAll{$ \text{pair of states } i,j  \in \mathcal{S}$}
